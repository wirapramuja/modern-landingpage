    ...
    <section>
      <Element name='pricing'>
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l broder-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
          ...
          {/* Pricing section */}
          <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:py-6'>
            {plans.map((plan, index) => (
                <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 py-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                    {index === 1 && (
                    ...
                    <div className={clsx('relative flex flex-col items-center', index ===1 ? 'pt-24' : 'pt-12')}>
                        ...
                        <div className='relative z-2 flex items-center justify-center'>
                            ...
                            <div className='small-1 relative top-3 uppercase '>
                                /mo
                            </div>
                        </div>
                    </div>
